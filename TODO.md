...
- Add playhead, then in "src/hooks/EditorUI.cpp" add checks for if a keyframe is on the same track and same time then don't auto-create.
    - Also add time for Keyframe with playhead
- UI!
- Add alpha, color, transform stuff, and hsv into Keyframe - Keyframe.hpp/Track.cpp
...
- Add Playhead Scrubbing too (using .update and stuff) - AnimationManager.cpp
